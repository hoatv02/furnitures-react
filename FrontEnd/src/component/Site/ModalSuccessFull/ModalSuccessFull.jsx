...
const ModalSuccessFull = ({removeModal}) => {
  return (
    <div
    ...
    aria-modal="true"
  >
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity transition delay-5000 duration-300 ease-in-out"></div>
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          <p className="justify-right text-right p-2">
            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <p className="pb-6">
                  ...
                  <i className={`${styles.iconSuccess} fa-regular fa-circle-check fa-frog fa-bounce`} ></i>
                  {/* <i className="fa-solid fa-frog fa-bounce" 
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Hãy đăng nhập ngay để trải nghiệm website một cách
                    tốt nhất !!!
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 px-4 py-4 sm:flex sm:flex-row justify-center sm:px-6 text-align:center">
            <Link
            to='/signin'
              onClick={() => removeModal()}
